...
class userstatus_timechecker_generator extends testing_data_generator {
    ...
    public function test_create_preparation () {
        ...
        $userarchived = $generator->create_user(array('username' => 'userarchivedmanually', 'lastaccess' => $oneyearnintydays,
            'suspended' => 1));
        ...
        $reactivate = $generator->create_user(array('username' => get_config('tool_cleanupusers_settings', 'suspendusername'), 'suspended' => 1));
